          ...
          <form className='modal-form'>
            ...
            <fieldset>
              ...
              <div className='add-item-burger'>
                ...
                <Input type='checkbox' className='radio-cheese' name='option-burger' id='option-cheese' value='↳ queijo' onChange={e => setOption(e.target.value)} />
              </div>
              <div className='add-item-burger'>
                <label htmlFor='option-egg'>Ovo</label>
                <Input type='checkbox' className='radio-option' name='option-burger' id='option-egg' value='↳ ovo' onChange={e => setOption(e.target.value)} />
              </div>
            </fieldset>
            <Button name='CONFIRMAR' type="button" handleClick={() => { props.setBurger(meat, 0, option) }} />
          </form>
        </div>
      </section>
    </div>
